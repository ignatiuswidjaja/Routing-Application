...
public class TestDateUtil {
  ...
  public void testConvertDateTimeToTimePeriod() {
    Assert.assertEquals(TimePeriod.OTHER, DateUtil.convertDateTimeToTimePeriod(null));

    // Friday, 16 Oct 2020, 9:00 AM
    DateTime dateTime = new DateTime(2020, 10, 16, 9, 0);
    Assert.assertEquals(TimePeriod.PEAK, DateUtil.convertDateTimeToTimePeriod(dateTime));

    // Friday, 16 Oct 2020, 10:00 AM
    dateTime = new DateTime(2020, 10, 16, 10, 0);
    Assert.assertEquals(TimePeriod.OTHER, DateUtil.convertDateTimeToTimePeriod(dateTime));
    ...
    Assert.assertEquals(TimePeriod.NIGHT, DateUtil.convertDateTimeToTimePeriod(dateTime));
